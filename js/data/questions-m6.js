...
{ id:"m6-02", mod:"M6", topic:"Acid–base theories", diff:2,
  ...
  choices:["Cannot explain why ammonia is basic without containing OH⁻","Cannot explain strong acids","Ignores the role of water entirely","Only applies to organic acids"],
...
{ id:"m6-05", mod:"M6", topic:"Strong vs weak", diff:2,
  ...
  choices:["Strong refers to degree of ionisation; concentrated refers to moles per litre","They mean the same thing","Strong acids are always concentrated","Concentrated acids fully ionise"],
...
{ id:"m6-10", mod:"M6", topic:"Kw", diff:3,
  ...
  choices:["Still neutral, because [H₃O⁺] = [OH⁻]","Acidic, because pH < 7","Basic","Impossible — pure water is always pH 7"],
...
{ id:"m6-13", mod:"M6", topic:"Ka and pKa", diff:2,
  ...
  choices:["X is the stronger acid and has the weaker conjugate base","Y is stronger","X has a smaller Ka","They ionise to the same extent"],
...
{ id:"m6-14", mod:"M6", topic:"Salt hydrolysis", diff:3,
  ...
  choices:["Basic, because ethanoate hydrolyses to give OH⁻","Acidic","Neutral","Basic, because Na⁺ reacts with water"],
...
{ id:"m6-16", mod:"M6", topic:"Neutralisation", diff:2,
  ...
  choices:["H⁺(aq) + OH⁻(aq) → H₂O(l)","HCl + NaOH → NaCl + H₂O","H₂O → H⁺ + OH⁻","Na⁺ + Cl⁻ → NaCl"],
...
{ id:"m6-17", mod:"M6", topic:"Titration", diff:2,
  ...
  choices:["Phenolphthalein (8.3–10.0)","Methyl orange (3.1–4.4)","Methyl red (4.4–6.2)","Any indicator will work"],
...
{ id:"m6-20", mod:"M6", topic:"Titration technique", diff:2,
  ...
  choices:["Add extra moles of analyte, giving a titre that is too high","Have no effect","Give a titre that is too low","Only affect precision, not accuracy"],
...
{ id:"m6-21", mod:"M6", topic:"Titration technique", diff:2,
  ...
  choices:["Residual water would dilute the titrant, giving a titre that is too high","To remove air bubbles","To warm the glassware","To sterilise it"],
...
{ id:"m6-22", mod:"M6", topic:"Primary standards", diff:2,
  ...
  choices:["It must be a strong acid or base","High purity","Known, stable composition","High molar mass to reduce weighing error"],
...
{ id:"m6-23", mod:"M6", topic:"Primary standards", diff:2,
  ...
  choices:["It is hygroscopic and absorbs CO₂ from the air","It is too weak a base","It has too high a molar mass","It is insoluble"],
...
{ id:"m6-24", mod:"M6", topic:"Buffers", diff:3,
  ...
  choices:["A weak acid and its conjugate base in comparable amounts","A strong acid and a strong base","Any solution with pH 7","A saturated salt solution"],
...
{ id:"m6-25", mod:"M6", topic:"Buffers", diff:3,
  ...
  choices:["HCO₃⁻ to accept H⁺, shifting left and limiting the pH drop","The pH to fall sharply","HCO₃⁻ concentration to increase","H₂CO₃ to ionise further"],
...
{ id:"m6-26", mod:"M6", topic:"Back titration", diff:3,
  ...
  choices:["The solid reacts slowly or incompletely, so a direct titration has no sharp end point","NaOH is a primary standard","It uses less glassware","Antacids are strong bases"],
...
{ id:"m6-27", mod:"M6", topic:"Enthalpy of neutralisation", diff:3,
  ...
  choices:["Energy is absorbed to fully ionise the weak acid","The weak acid is more dilute","Fewer moles react","The reaction is incomplete"],
...
{ id:"m6-28", mod:"M6", topic:"Titration curves", diff:3,
  ...
  choices:["A diprotic acid such as carbonic acid","A strong monoprotic acid","A buffer","An error in the titration"],
...
{ id:"m6-30", mod:"M6", topic:"Acid reactions", diff:2,
  ...
  choices:["Carbon dioxide","Hydrogen","Oxygen","Chlorine"],
...
{ id:"m6-31", mod:"M6", topic:"Acid reactions", diff:2,
  ...
  choices:["Magnesium + dilute hydrochloric acid","Copper + dilute hydrochloric acid","Sodium carbonate + acid","Sodium hydroxide + acid"],
...
{ id:"m6-32", mod:"M6", topic:"Volumetric analysis", diff:3,
  ...
  choices:["Until the bottom of the meniscus sits on the calibration mark at eye level","Until the flask is full to the neck","To the top of the meniscus","Roughly to the mark — precision is not important"],
