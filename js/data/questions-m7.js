...
{ id:"m7-02", mod:"M7", topic:"Nomenclature", diff:2,
  ...
  choices:["2-methylpentane","3-methylpentane","2-methylbutane","hexane"],
...
{ id:"m7-08", mod:"M7", topic:"Intermolecular forces", diff:2,
  ...
  choices:["The -OH group allows hydrogen bonding","Butan-1-ol has a much larger molar mass","Butane is ionic","Butan-1-ol is branched"],
...
{ id:"m7-10", mod:"M7", topic:"Solubility", diff:2,
  ...
  choices:["The non-polar hydrocarbon chain dominates over the polar -OH group","The -OH group is lost","Longer alcohols are ionic","Hydrogen bonding becomes stronger"],
...
{ id:"m7-12", mod:"M7", topic:"Reactions of alkenes", diff:2,
  ...
  choices:["Addition, forming 1,2-dibromoethane","Substitution, forming bromoethane","Oxidation to ethanol","Combustion"],
...
{ id:"m7-14", mod:"M7", topic:"Haloalkanes", diff:2,
  ...
  choices:["Propan-1-ol via nucleophilic substitution","Propene via elimination only","Propanoic acid","Propanal"],
...
{ id:"m7-15", mod:"M7", topic:"Oxidation of alcohols", diff:3,
  ...
  choices:["Propanoic acid","Propanal only","Propanone","No reaction"],
...
{ id:"m7-16", mod:"M7", topic:"Oxidation of alcohols", diff:2,
  ...
  choices:["2-methylpropan-2-ol","Propan-1-ol","Propan-2-ol","Ethanol"],
...
{ id:"m7-17", mod:"M7", topic:"Esterification", diff:2,
  ...
  choices:["Ethyl ethanoate and water","Ethyl ethanol","Ethanal and water","Ethene"],
...
{ id:"m7-19", mod:"M7", topic:"Esterification", diff:2,
  ...
  choices:["To prevent loss of volatile reactants while allowing prolonged heating","To speed up the reaction by increasing pressure","To remove water and shift equilibrium","To purify the ester"],
...
{ id:"m7-20", mod:"M7", topic:"Saponification", diff:3,
  ...
  choices:["A strong base, producing soap and glycerol","A strong acid, producing an ester","An alcohol, producing an ester","Water alone"],
...
{ id:"m7-21", mod:"M7", topic:"Soaps and detergents", diff:2,
  ...
  choices:["A non-polar tail that dissolves grease and a polar head that dissolves in water","Two polar ends","A charged tail","Only non-polar regions"],
...
{ id:"m7-22", mod:"M7", topic:"Soaps and detergents", diff:3,
  ...
  choices:["Ca²⁺ and Mg²⁺ form an insoluble scum with the fatty acid anions","Hard water is too acidic","Soaps decompose above 20 °C","Hard water contains detergents"],
...
{ id:"m7-23", mod:"M7", topic:"Addition polymers", diff:2,
  ...
  choices:["Chloroethene","Ethene","Propene","Styrene"],
...
{ id:"m7-24", mod:"M7", topic:"Polymers", diff:3,
  ...
  choices:["LDPE is heavily branched, giving weaker dispersion forces and a lower melting point","LDPE has a higher molar mass","HDPE contains double bonds","LDPE is a condensation polymer"],
...
{ id:"m7-25", mod:"M7", topic:"Condensation polymers", diff:3,
  ...
  choices:["A small molecule such as water is eliminated at each linkage","They contain only carbon and hydrogen","They form from alkenes","Each monomer has one functional group"],
...
{ id:"m7-28", mod:"M7", topic:"Biofuels", diff:2,
  ...
  choices:["The CO₂ released was recently absorbed by the crop during photosynthesis","It produces no CO₂","It is made from crude oil","It contains more energy than petrol"],
...
{ id:"m7-30", mod:"M7", topic:"Amines and amides", diff:3,
  ...
  choices:["They are basic because the nitrogen lone pair accepts a proton","They are acidic","They cannot hydrogen bond","They contain a carbonyl group"],
...
{ id:"m7-31", mod:"M7", topic:"Acid reactions", diff:2,
  ...
  choices:["Sodium ethanoate, water and carbon dioxide","Ethanol and CO₂","An ester","No reaction"],
...
{ id:"m7-32", mod:"M7", topic:"Structure", diff:3,
  ...
  choices:["Every carbon–carbon bond is a single bond, so no more atoms can be added","They dissolve in water","They contain only carbon","They react readily with bromine"],
